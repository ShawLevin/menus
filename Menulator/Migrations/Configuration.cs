namespace Menulator.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Menulator.DataAccess.MenulatorContext>
    {
        ...
        protected override void Seed(Menulator.DataAccess.MenulatorContext context)
        {
