namespace Menulator.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Menulator.DataAccess.RestaurantContext>
    {
        ...
        protected override void Seed(Menulator.DataAccess.RestaurantContext context)
        {
            ...
            context.Locations.Add(new Location { Address = "1235 Street", ID = 0, Phone = "60928999667", Title = "Drexel Pizza", RestaurantID = 0, Latitude = 39.9590446, Longitude = -75.1911044 });
            context.Locations.Add(new Location { Address = "Key West Street", ID = 0, Phone = "1234567890", Title = "Blue Moon Cafe", RestaurantID = 0, Latitude = 24.5583574, Longitude = -81.7802537 });
